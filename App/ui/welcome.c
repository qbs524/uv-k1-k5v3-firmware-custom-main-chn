...
void UI_DisplayWelcome(void)
{
    ...
    if (gEeprom.POWER_ON_DISPLAY_MODE == POWER_ON_DISPLAY_MODE_NONE || gEeprom.POWER_ON_DISPLAY_MODE == POWER_ON_DISPLAY_MODE_SOUND) {
        ...
        UI_PrintStringSmallNormal(Version, 0, 127, 2);
        UI_PrintStringSmallNormal("BA7IQE", 0, 96, 5);
        UI_PrintString("บบปฏ", 100, 127, 4, 16);
        ST7565_BlitFullScreen();
#else
    if (gEeprom.POWER_ON_DISPLAY_MODE == POWER_ON_DISPLAY_MODE_NONE || gEeprom.POWER_ON_DISPLAY_MODE == POWER_ON_DISPLAY_MODE_FULL_SCREEN) {
        ...
        UI_PrintStringSmallNormal(Version, 0, 96, 4);
        UI_PrintStringSmallNormal("BA7IQE", 48, 0, 5);
        UI_PrintString("บบปฏ", 96, 0, 4, 16);
